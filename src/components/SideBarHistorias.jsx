      ...
      <CDBSidebar textColor="#fff" backgroundColor="#033d3d">
        ...
        <CDBSidebarContent className="sidebar-content">
          ...
          <NavLink exact to="/homeadmin" activeClassName="activeClicked">
            ...
            <NavLink exact to="/histories" activeClassName="activeClicked">
              <CDBSidebarMenuItem icon="columns">Historias</CDBSidebarMenuItem>
            </NavLink>

            <NavLink exact to="/createHistory" activeClassName="activeClicked">
              <CDBSidebarMenuItem icon="user">Registrar Historia</CDBSidebarMenuItem>
            </NavLink>
...
export default SideBarHistorias
